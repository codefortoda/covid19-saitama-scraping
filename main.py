        ...
        "children": [
            {
                ...
                "children": [
                    {
                        "attr": "入院中",
                        "value": main_sum[2] + main_sum[4] + main_sum[6] + main_sum[10],
                        "children": [
                            {"attr": "軽症・中等症", "value": main_sum[2] - main_sum[3]  + main_sum[4] + main_sum[6] + main_sum[10]},
                            {"attr": "重症", "value": main_sum[3]},
                        ],
                    },
                    {"attr": "退院", "value": main_sum[7]},
                    {"attr": "死亡", "value": main_sum[8]},
                ],
            }
        ],
    }
